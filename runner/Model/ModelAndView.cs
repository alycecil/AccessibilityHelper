...
namespace IO.Swagger.Model
{
    ...
    public partial class ModelAndView :  IEquatable<ModelAndView>, IValidatableObject
    {
        ...
        public ModelAndView(bool? empty = default(bool?), Object model = default(Object), Dictionary<string, Object> modelMap = default(Dictionary<string, Object>), bool? reference = default(bool?), StatusEnum? status = default(StatusEnum?), View view = default(View), string viewName = default(string))
        {
            this.Empty = empty;
            this.Model = model;
        ...
        {
            return this.Equals(input as ModelAndView);
        }

        /// <summary>
        /// Returns true if ModelAndView instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelAndView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelAndView input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ModelMap == input.ModelMap ||
                    this.ModelMap != null &&
                    this.ModelMap.SequenceEqual(input.ModelMap)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ModelMap != null)
                    hashCode = hashCode * 59 + this.ModelMap.GetHashCode();
