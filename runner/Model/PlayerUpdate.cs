...
namespace IO.Swagger.Model
{
    ...
    public partial class PlayerUpdate :  IEquatable<PlayerUpdate>, IValidatableObject
    {
        ...
        public PlayerUpdate(bool? combatWindowOpen = default(bool?), bool? exitedCombat = default(bool?), int? hp = default(int?), int? mana = default(int?), string name = default(string), int? weaponStatus = default(int?), int? weight = default(int?))
        {
