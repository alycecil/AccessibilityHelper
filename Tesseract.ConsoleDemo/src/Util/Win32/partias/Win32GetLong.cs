...
namespace runner
{
    public static partial class Win32
    {
        ...
        public static extern long GetWindowLongW(IntPtr hWnd, WindowLongParam nIndex);
        [DllImport("user32.dll")]
        public static extern long GetWindowLongA(IntPtr hWnd, WindowLongParam nIndex);
